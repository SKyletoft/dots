...
_kill() {
	pidof $1 | sudo xargs kill
}

alias ls="exa -a"
alias find="fd -E /mnt/SDA -E /mnt/SDD"
alias du=dust
alias top=btm
alias grep=rg
...
alias pi="ssh skyletoft@81.225.236.121 -p2222"
alias python="python3"
alias tupdate="time update"
alias dns-clear="sudo systemd-resolve --flush-caches"
alias hackeholken="ssh 3836@dtek.se -p222"
#alias please="sudo !!"
alias cd="z"
alias nsway="sway --my-next-gpu-wont-be-nvidia"
